...
class LmScraperSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        # ~/cloudfiles/code/Users/flabastie/news/scrapy_projects/lemonde_covid/lemonde_covid/spiders/custom_sw.json
        with open('./lemonde_covid/spiders/custom_sw.json') as f:
